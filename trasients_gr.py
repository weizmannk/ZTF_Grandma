...
fig.suptitle("abbzjeq;" + " abfmbix;"+" abfaohe;"+" absvlrr;" + " ablssud;"+ " abultbr;"+" acceboj")
            ...
            if save_file_name[i] in f:   
                ...
                try:
                    ...
                    if filter == "g":
                        ...
                        axs.errorbar(t_dec-tmin_inc, y_dec+offset, dy_dec, fmt=g_fmt, c=g_color, label=filter)
                        ...
                        if save_file_name[i] == "ZTF21abbzjeq":                          
                            ...
                            axs.text(x_dec, y_dec, r'  %.3f ' % slope_dec, rotation=-45, color="k", fontsize=10)

                        elif save_file_name[i] == "ZTF21abfaohe":  
                            indy_dec = np.where(y_dec == np.max(y_dec))
                            x_dec = t_dec[indy_dec]-6.5
                            y_dec = np.max(y_dec)+0.5
                            axs.text(x_dec, y_dec, r'  %.3f ' % slope_dec, rotation=-30, color="k", fontsize=10)
                        
                        elif save_file_name[i] == "ZTF21acceboj":
                            indy_dec = np.where(y_dec == np.max(y_dec))
                            x_dec = t_dec[indy_dec]-10
                            y_dec = np.max(y_dec)+0.5
                            axs.text(x_dec, y_dec, r'  %.3f ' % slope_dec,  rotation=0, color="k", fontsize=10)
                        ...
                        if save_file_name[i] == "ZTF21acceboj":
                            ...
                            axs.errorbar(t_dec-tmin_inc, y_dec , dy_dec, fmt=r_fmt, c=r_color, label=filter)
                            ...
                            if save_file_name[i] == "ZTF21abbzjeq":                          
                                ...
                                x_dec = t_dec[indy_dec]-15
                                y_dec = np.max(y_dec)-0.15
                                axs.text(x_dec, y_dec, r'   %.3f ' % slope_dec, rotation=-20, color="k", fontsize=10)
                ...
                try:
                    ...
                    if filter == "g":
                        ...
                        axs.errorbar(t_dec-tmin_dec, y_dec +offset, dy_dec, fmt=g_fmt, c=g_color, label= filter)
...
axs.grid(True)
axs.legend(shadow=True,  ncol=2, fancybox=True, loc='best')
axs.invert_yaxis()
